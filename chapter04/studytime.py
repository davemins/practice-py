...
while i != 'end':
    ...
    print("cur_time : {} || elap_time : {}시간 {}분 || rem_time : {}시간 {}분" \
        .format(tmp_cur, int((elap_time).seconds / 3600), int(((elap_time).seconds % 3600) / 60), int((rem_time).seconds / 3600), int(((rem_time).seconds % 3600) / 60)))
